...
export default {
    ...
    admin: {
      ...
      usernameCopied: 'Nome de utilizador copiado para a área de transferência!',
      copyAll: 'Copiar Todos',
      copyAllUsernames: 'Copiar todos os nomes de utilizador',
      allUsernamesCopied: '{count} nomes de utilizador copiados para a área de transferência!',
    ...
    scheduleForm: {
      ...
      usernameAutoFilled: 'Preenchido automaticamente da sua conta',
