...
export default {
    ...
    admin: {
      ...
      copyAll: 'Tout Copier',
      copyAllUsernames: 'Copier tous les noms d\'utilisateur',
      allUsernamesCopied: '{count} noms d\'utilisateur copiés dans le presse-papiers !',
    ...
    scheduleForm: {
      ...
      usernameAutoFilled: 'Rempli automatiquement depuis votre compte',
    ...
    autoRefresh: {
      ...
      disabled: 'Actualisation automatique désactivée',
      refresh: 'Actualiser',
      manualRefresh: 'Cliquez pour actualiser maintenant',
      updating: 'Mise à jour...',
    },
    ...
    events: {
      ...
      createdBy: 'Créé par',
      serverTime: 'Heure du Serveur',
      timesInServerTime: 'Toutes les heures affichées en heure du serveur',
      rsvp: 'RSVP',
      going: 'J\'y vais',
      maybe: 'Peut-être',
      ...
      rsvpFailed: 'Échec de la mise à jour du RSVP',
      ...
      deleteConfirm: 'Supprimer cet événement et tous les RSVPs?',
      noUpcomingEvents: 'Aucun événement à venir',
      noPastEvents: 'Aucun événement passé',
      noEventsYet: 'Aucun événement n\'a encore été créé',
      createFirstEvent: 'Créer le Premier Événement',
      manageEventsAndRSVPs: 'Gérer les événements de l\'alliance et suivre les RSVPs',
      noMembersInCategory: 'Aucun membre dans cette catégorie',
      eventNamePlaceholder: 'ex., Raid du Samedi Soir',
      descriptionPlaceholder: 'Ajouter des détails ou des instructions...',
